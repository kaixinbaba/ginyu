...
@Command(name = "incrby", checkExpire = true)
public class IncrBy extends AbstractRedisCommand<CrementByArg, BulkStrings> {
    @Override
    ...
    protected void validate(String commandName, Arrays arrays) {
        ...
        Validates.validateInteger(arrays, 2, "increment");
    }
